...
# Jardim Brasil
    Unidade.create :nome => "TARAGUA", :tipo => 3, :regiao_id => 7

# Praia Azul
    Unidade.create :nome => "PITANGA", :tipo => 3, :regiao_id => 9
    Unidade.create :nome => "PANAMBY", :tipo => 3, :regiao_id => 9

# JARDIM DA PAZ
   Unidade.create :nome => "ARAPIRANGA", :tipo => 3 , :regiao_id => 10

# JARDIM DOS LIRIOS
    Unidade.create :nome => "ARAUNA", :tipo => 3, :regiao_id => 11

# PARQUE DAS NACOES
      Unidade.create :nome => "BITU", :tipo => 3, :regiao_id => 12

# SAO ROQUE
  Unidade.create :nome => "JURITI", :tipo => 3, :regiao_id => 13
    
# PARQUE GRAMADO
  Unidade.create :nome => "MAIRA", :tipo => 3, :regiao_id  => 14

# JARDIM PROGRESSO
  Unidade.create :nome => "MANACA", :tipo => 3, :regiao_id => 15

# PROFILURB
  Unidade.create :nome => "URUPE", :tipo => 3, :regiao_id => 16

# JARDIM LILASES
  Unidade.create :nome => "ANAJA", :tipo => 1, :regiao_id => 17

# PARQUE LIBERADADE
    Unidade.create :nome => "CAIC", :tipo => 1, :regiao_id => 18

# MATHIENSEN
    Unidade.create :nome => "CHUI", :tipo => 1, :regiao_id => 19

# CORDENUCI
    Unidade.create :nome => "MAJOI", :tipo => 1, :regiao_id => 20

# JARDIM SÃO PEDRO
   Unidade.create :nome => "MARACA", :tipo => 1, :regiao_id => 21

# SAO MONOEL
    Unidade.create :nome => "TAPERA", :tipo => 1, :regiao_id => 22
